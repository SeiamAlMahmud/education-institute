...
const CardExampleCard = () => (
  <Card className='shadow-md max-w-sm rounded-md'>
    <Image src='https://www.ox.ac.uk/sites/files/oxford/styles/ow_listing/s3/field/field_image_main/Full%20Uehiro%20team.%20Photo%20credit%20Rocci%20Wilkinson.jpeg?itok=P3zM8cyz' wrapped ui={false} className='flex justify-center' />
